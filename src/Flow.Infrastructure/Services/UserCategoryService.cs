...
internal sealed class UserCategoryService : IUserCategoryService
{
    ...
    public async Task<UserCategoryDto> GetForUserAsync(Guid userId, Guid userCategoryId, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<List<UserCategoryDto>> GetAllForUserAsync(Guid userId, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<UserCategoryDto> CreateAsync(Guid userId, CreateUserCategoryDto createUserCategoryDto, CancellationToken cancellationToken = default)
    {
    ...
    public async Task UpdateAsync(Guid userId, Guid userCategoryId, UpdateUserCategoryDto updateUserCategoryDto, CancellationToken cancellationToken = default)
    {
        var userCategory = await _unitOfWork.UserCategories.GetForUserAsync(userId, userCategoryId, cancellationToken)
            ?? throw new NotFoundException();
